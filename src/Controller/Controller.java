   ...
   public void mostrarConvocatorias() {
    ...
    public void consultarEnunciadosPorUnidad() {
        ...
        try {
            ...
            statement = connection.prepareStatement(GET_ACRONIMO_UNIDAD);
            ...
            while (resultSet.next()) {
                UnidadDidactica unidadResult = new UnidadDidactica();
                unidadResult.setAcronimo(resultSet.getString("acronimo"));
                unidadesArray.add(unidadResult);
            }
        ...
        System.out.println("Acronimos de las unidades existentes: ");
        for (UnidadDidactica un : unidadesArray) {
            System.out.println(un.getAcronimo());
        }
